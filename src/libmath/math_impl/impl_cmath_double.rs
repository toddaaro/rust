...
native mod lib {
    ...
    pure fn frexp(n: t, &value: c_int) -> t;
    pure fn hypot(x: t, y: t) -> t;
    pure fn ldexp(x: t, n: c_int) -> t;
    #[cfg(target_os = "linux")]
    #[cfg(target_os = "macos")]
    #[cfg(target_os = "freebsd")]
    #[link_name="lgamma_r"] pure fn lgamma(n: t,
                                           &sign: c_int) -> t;
    #[cfg(target_os = "win32")]
    #[link_name="__lgamma_r"] pure fn lgamma(n: t,
                                             &sign: c_int) -> t;
...
//    pure fn rint(n: t) -> t;
    ...
    #[link_name="scalbn"] pure fn ldexp_radix(n: t, i: c_int) ->
        t;
    pure fn sin(n: t) -> t;
    pure fn sinh(n: t) -> t;
    pure fn sqrt(n: t) -> t;
