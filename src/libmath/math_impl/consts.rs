export radix, mantissa_digits, digits;
export min_exp, max_exp, min_10_exp, max_10_exp;
export min_value, max_value, epsilon;
export pi, frac_pi_2, frac_pi_4, frac_1_pi, frac_2_pi, frac_2_sqrtpi;
export sqrt2, frac_1_sqrt2, e, log2_e, log10_e, ln_2, ln_10;
