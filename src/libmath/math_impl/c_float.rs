...
native mod lib {
    ...
    #[link_name="modff"] fn modf(n: t, iptr: &mut t) -> t;
...
native mod lib_wrapped {
    #[link_name="frexpf"] fn frexp(n: t, value: *mut c_int) -> t;
    #[link_name="ldexpf"] pure fn ldexp(x: t, n: c_int) -> t;
    #[cfg(target_os="linux")]
    #[cfg(target_os="macos")]
    #[cfg(target_os="freebsd")]
    #[link_name="lgammaf_r"] fn lgamma(n: t, sign: *mut c_int) -> t;
    #[cfg(target_os="win32")]
    #[link_name="__lgammaf_r"] fn lgamma(n: t, sign: *mut c_int) -> t;
    #[link_name="scalbnf"] pure fn ldexp_radix(n: t, i: c_int) -> t;
}
